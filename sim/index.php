...
<html>
<head>
	<title>Login | Lestari Nganjuk</title>
	<style type="text/css">
	@font-face{
	...
	100%{opacity: 1;}
		...
		.both{clear: both;}
		.loginpage{position: fixed;background:url("assets/img/image-min.jpeg");height: 100%;width: 100%;background-size: 100%;}
...
<body>
	<div class="loginpage">
		...
		<div class="padding">
		    ...
		    <img src="assets/img/widada.jpeg" height="300" width="350">
			<!--<h3>Login</h3>-->
		<form id="loginapp">
