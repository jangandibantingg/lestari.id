	...
	<div class="padding">
		<div class="bgwhite">
			<div class="padding">
				...
				$data=$root->con->query("select barang.nama_barang,sub_transaksi.diskon,barang.harga_jual,sub_transaksi.jumlah_beli,sub_transaksi.total_harga from sub_transaksi inner join barang on barang.id_barang=sub_transaksi.id_barang where sub_transaksi.id_transaksi='$_GET[id_transaksi]'");
				...
				?>
				<tr>
					<td></td><td></td><td></td><td></td><td>Grand Total :</td><td> Rp. <?= number_format($getsum1['grand_total']) ?></td>
				</tr>
			</tbody>
				</table>
				<br>
